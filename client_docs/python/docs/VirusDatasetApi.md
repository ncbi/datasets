...
------------- | ------------- | -------------
[**get_sars2_summary**](VirusDatasetApi.md#get_sars2_summary) | **GET** /virus/summary/sars2/protein/{proteins} | Retrieve summary of SARS-CoV-2 datasets
[**get_summary**](VirusDatasetApi.md#get_summary) | **GET** /virus/summary/taxid/{tax_id} | Retrieve summary of Coronavirus datasets by taxonomy ID
[**get_summary_by_name**](VirusDatasetApi.md#get_summary_by_name) | **GET** /virus/summary/organism/{tax_name} | Retrieve summary of Coronavirus datasets by taxonomy name


# **get_sars2_summary**
> V1alpha1VirusDatasetSummary get_sars2_summary(proteins, refseq_only=refseq_only, annotated_only=annotated_only, released_since=released_since, host=host)

Retrieve summary of SARS-CoV-2 datasets
...
released_since = '2013-10-20T19:20:30+01:00' # datetime | Date since which to limit the request, to only retrieve newer assemblies. (optional)
 ...
 **released_since** | **datetime**| Date since which to limit the request, to only retrieve newer assemblies. | [optional] 
 **host** | **str**| Assemblies that were taken from this host (tax-id or name) or its taxonomic descendents. | [optional] 

### Return type

[**V1alpha1VirusDatasetSummary**](V1alpha1VirusDatasetSummary.md)
...
# **get_summary**
> V1alpha1VirusDatasetSummary get_summary(tax_id, refseq_only=refseq_only, annotated_only=annotated_only, released_since=released_since, host=host)

Retrieve summary of Coronavirus datasets by taxonomy ID
...
# **get_summary_by_name**
> V1alpha1VirusDatasetSummary get_summary_by_name(tax_name, refseq_only=refseq_only, annotated_only=annotated_only, released_since=released_since, host=host)

Retrieve summary of Coronavirus datasets by taxonomy name
