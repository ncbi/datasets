...
------------ | ------------- | ------------- | -------------
*DatasetDownloadApi* | [**dataset_download_get_prokaryote_gene_dataset_stream2**](docs/DatasetDownloadApi.md#dataset_download_get_prokaryote_gene_dataset_stream2) | **POST** /protein/accession/download | Retrieve Prokaryote Gene data package.
...
## Documentation For Models
 ...
 - [StreamResultOfProtobufBytesValue](docs/StreamResultOfProtobufBytesValue.md)
